...
const App: React.FC = () => {
  ...
  const [harList, setHarList] = useState<Har[]>(INITIAL_HAR);
  const [rowList, setRowList] = useState<Row[]>(INITIAL_ROW);
  const [tujuanList, setTujuanList] = useState<Tujuan[]>(INITIAL_TUJUAN);
